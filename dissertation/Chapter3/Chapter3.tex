...
In order to clearly explain the design of the new system, namely an extension that will be made to the OP2 framework, it is important to first describe the existing work-flow. Understanding the existing in the codebase before the start of the project should make it clearer what addition has been made.
